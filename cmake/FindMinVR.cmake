find_path(MinVR_INCLUDE_DIR VRMain.h
          HINTS ${CMAKE_SOURCE_DIR}/../MinVR/build/install/include/main)
...
find_library(MinVR_OPT_LIBRARIES NAMES libMinVR.a MinVR.lib MinVR
          HINTS ${CMAKE_SOURCE_DIR}/../MinVR/build
		${CMAKE_SOURCE_DIR}/../MinVR/build/install/lib
		${CMAKE_SOURCE_DIR}/../MinVR/build/Release/lib)
          
find_library(MinVR_DEBUG_LIBRARIES NAMES libMinVRd.a MinVRd.lib MinVRd
          HINTS ${CMAKE_SOURCE_DIR}/../MinVR/build
		${CMAKE_SOURCE_DIR}/../MinVR/build/install/lib
	  	${CMAKE_SOURCE_DIR}/../MinVR/build/Debug/lib)
